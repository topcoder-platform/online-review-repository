...
public class ProjectService extends ProjectServiceGrpc.ProjectServiceImplBase {
    ...
    public void getAllProjects(GetAllProjectsRequest request, StreamObserver<GetAllProjectsResponse> responseObserver) {
        ...
        List<ProjectProto> result = dbAccessor.executeQuery(sql, (rs, _i) -> {
            ...
            ProjectPropertyProto.Builder p1Builder = ProjectPropertyProto.newBuilder();
            p1Builder.setName("Project Name");
            ResultSetHelper.applyResultSetString(rs, 2, p1Builder::setValue);
            builder.addProperties(p1Builder.build());
            ProjectPropertyProto.Builder p2Builder = ProjectPropertyProto.newBuilder();
            p2Builder.setName("Project Version");
            ResultSetHelper.applyResultSetString(rs, 3, p2Builder::setValue);
            builder.addProperties(p2Builder.build());
            ProjectPropertyProto.Builder p3Builder = ProjectPropertyProto.newBuilder();
            p3Builder.setName("Root Catalog ID");
            ResultSetHelper.applyResultSetString(rs, 4, p3Builder::setValue);
            builder.addProperties(p3Builder.build());
            ProjectPropertyProto.Builder p4Builder = ProjectPropertyProto.newBuilder();
            p4Builder.setName("Winner External Reference ID");
            ResultSetHelper.applyResultSetString(rs, 5, p4Builder::setValue);
            builder.addProperties(p4Builder.build());
