 ...
 */
package com.topcoder.or.component.search.filter;

import com.topcoder.or.component.datavalidator.ObjectValidator;
import com.topcoder.or.component.search.ValidationResult;
import com.topcoder.or.component.search.builder.LikeFragmentBuilder;
 ...
 * this filter searches a textual field for a specified substring that is
 * contained in it.
 * The substring can appear anywhere, including the beginning, the end and any
 * other places.
 * The filter works for database and LDAP. And also it supports wildcard
 * searching.
 * </p>
 *
 * <p>
 * Four types of value are supported, which are CONTAINS, START_WITH, END_WITH
 * and WITH_CONTENT,
...
public class LikeFilter implements Filter {
    ...
    /**
     * <p>
     * Represents escape character to escape the wildcard in SQL ('%' and '_') and
     * LDAP ( '*').
     * It is initialzed in constructor and never changed later. It can be accessed
     * by the getter.
     * Its default value is '\'.
     * <p>
     *
     * </p>
     * It cann't be some special chars, all the invalid chars are defined in
     * INVALID_ESCAPE array.
     * </p>
     *
     */
    ...
    /**
     * <p>
     * Create a new instance with the given name and value.
     * </p>
     *
     *
     *
     ...
     *                                  or value does not begin with 'SS:', 'SW:',
     *                                  'EW:', 'WC:',
    ...
    /**
     * <p>
     * Create a new instance with the given name, value and escape character.
     * </p>
     *
     * <p>
     * Note: the escape character can not be '%', '_' and '*'.
     * </p>
     *
     * @param name            the filed name of the search criterion
     * @param value           the searching value
     ...
     *                                  'EW:', 'WC:',
     *                                  or value is zero length without the prefix,
     *                                  or escapeCharacter is of some special
     *                                  invalid chars.
     */
    ...
    /**
     * <p>
     * Check whether the filter is valid according to the rules presented in the
     * validators.
     * </p>
     *
     *
     ...
     * @return the <code>ValidationResult</code> object denote whether the
     *         validation is successful or not
     * @throws IllegalArgumentException if any parameter is Null, or the key of any
     *                                  parameter is not String,
     *                                  or the value of validators is not
     *                                  ObjectValidator, or the value of alias is
     *                                  not String,
     *                                  or no rule can be found via the filed name
     *                                  of this filter.
     */
    public ValidationResult isValid(Map validators, Map alias) {
        ...
        if (rule == null) {
            // if no ObjectValidator can be retrieved via the real name, get the
            // ObjectValidator via the alias
     ...
     * @throws IllegalArgumentException if the map is null, or keys are not all of
     *                                  String,
     *                                  or values are not all with the expected
     *                                  class.
     */
    ...
    /**
     * <p>
     * Get a clone object of this filter.
     * </p>
     *
     *
