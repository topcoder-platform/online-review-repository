...
final class FilterHelper {
     ...
     * @throws IllegalArgumentException if the list is empty or the items in it is
     *                                  null
     */
     ...
     * The mothed also check the key and value in the map which also should not be
     * null.
     *
     * Note: The map checked in the filters can be empty,eg. the alias is empty
     * means
     * there is no fieldName has aliasName.
     * 
     * @param map     The map to be checked
     * @param mapName the Name of the map, which denote the usage of the map
     * @throws IllegalArgumentException if the map is null or the key and value in
     *                                  it is null
    ...
    /**
     * Check the SimpleFilter whether it is legal for rule which is stored in the
     * map validators.
     ...
     * @param value      the Comparable object to be checked valid according the
     *                   above rule
    ...
    /**
     * Check the AssociativeFilter whether it is legal for rule which is stored in
     * the map validators.
     * The rule is got by the name or the aliasName according it.
     *
     * @param validators a map containing <code>ObjectValidator</code> Objects
