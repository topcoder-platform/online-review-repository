...
import com.topcoder.or.component.search.builder.RangeFragmentBuilder;
 ...
 * sreaterThan
 * search criterion. This class also provides concrete isValid(), and
...
public class GreaterThanFilter extends AbstractSimpleFilter {
    /**
     * <p>
     * Create a new instance, by setting name and value.
     * </p>
     *
     *
    ...
    /**
     * <p>
     * Check if the filter is valid according to the rules presented in the
     * validators,
     ...
     * @throws IllegalArgumentException if any parameter is Null
     * @throws IllegalArgumentException if validators do not contain the rule for
     *                                  the name.
     */
