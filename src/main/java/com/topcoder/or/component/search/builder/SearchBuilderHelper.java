 ...
 */
package com.topcoder.or.component.search.builder;

import com.topcoder.or.component.search.SearchContext;
import com.topcoder.or.component.search.UnrecognizedFilterException;
import com.topcoder.or.component.search.filter.AbstractAssociativeFilter;
import com.topcoder.or.component.search.filter.AbstractSimpleFilter;
...
/**
 * This helperClass of the package com.topcoder.search.builder. The class offers
 * some check mothed
...
public final class SearchBuilderHelper {
  ...
  /**
   * Build the search String for Simple Filter, include NullFilter,
   * EqualsToFilter, and
   ...
   * @throws UnrecognizedFilterException if can not get all the inner builder
   *                                     successfully
   */
  ...
  /**
   * Build the search String for AbstractAssociativeFilter, the filter is for
   * database.
   *
   * <p>
   * This method is added in version 1.3.
   ...
   * The mothed also
   * check the items in the list which also should be with the expected class
   * type.
   *
   * <p>
   * This method is added in version 1.3.
   ...
   * @throws IllegalArgumentException if the list is null, the items in it is
