...
import com.topcoder.or.component.search.builder.OrFragmentBuilder;
...
/**
 * This class extends AbstractAssociativeFilter. It is used to construct OR
 * search criterion. The
 * class is thread safe. The filter attribute is initialized by constructor, and
 * changed by
 * addFilter() method, all other methods use it. Thus it is like a read-write
 * structure.
 *
 * <p>
...
public class OrFilter extends AbstractAssociativeFilter {
  /**
   * Create a new instance,by setting the first and second filter add them to the
   * list of filters.
   *
