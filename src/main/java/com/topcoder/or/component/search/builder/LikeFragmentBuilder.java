...
public class LikeFragmentBuilder implements SearchFragmentBuilder {
    ...
    /**
     * <p>
     * Builds according to the LikeFilter.
     * </p>
     *
     ...
     * @throws UnrecognizedFilterException if the filter cannot be handled by this
     ...
     * Four types of <code>LikeFilter</code> are supported(refer the class doc of
    ...
    /**
     * <p>
     * Transform a String, escapes '%' and '_' in the content by adding escapeChar
     * before them.
     * </p>
     *
     * <p>
     * This method is updated in version 1.2.
     * </p>
     *
