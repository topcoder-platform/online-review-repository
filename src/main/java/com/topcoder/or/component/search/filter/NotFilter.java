...
import com.topcoder.or.component.search.builder.NotFragmentBuilder;
...
public class NotFilter implements Filter {
    ...
    /**
     * <p>
     * Create a new instance,by setting filterToNegate.
     * </p>
     *
     *
     * @param filterToNegate filter to be negated.
     * @throws IllegalArgumentException if any parameter is Null
     * @throws IllegalArgumentException if the filterToNegate is equal to the
     *                                  notFilter itself.
     */
