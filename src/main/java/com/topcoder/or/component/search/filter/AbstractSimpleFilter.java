 ...
 * This abstract class provides some common functions shared among concrete
 * simple filter classes.
 * </p>
 *
...
public abstract class AbstractSimpleFilter implements Filter {
    ...
    /**
     * It will hold a Comparable object. For example, if a LessThan filter is built
     * by the constrcutor,
     * then this attribute is initialized by the Comparable object in the
     * constructor.
    ...
    /**
     * It will hold a Comparable object representing the upper threshold of this
     * filter.
     *
     */
    ...
    /**
     * It will hold a Comparable object representing the lower threshold of this
     * filter.
     *
     */
    ...
    /**
     * <p>
     * Create a new instance,by providing the name and value.
     * </p>
     *
     *
     * @param name  the filed name of the search criterion
     * @param value a Comparable object used to set the upperThreshold and
     *              lowerThreshold attributes
    ...
    /**
     * <p>
     * Create a new instance,by providing the name ,upperThreshold and
     * isUpperThresholdInclusive.
    ...
    /**
     * <p>
     * return the upper threshold value of the field.
     * </p>
     *
    ...
    /**
     * <p>
     * return the lower threshold value of the field.
     * </p>
     *
