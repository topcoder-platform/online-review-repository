...
/**
 * <p>
 * This class models the filter validtion result. It is used by SearchBundle
 * class and all classes in the
...
public class ValidationResult {
    ...
    /**
     * It holds the message describing why validation fails if <code>isValid</code>
     * is false.
     *
     */
    ...
    /**
     * It holds the most relevant <code>Filter</code> object which fails the
     * validation
    ...
    /**
     * <p>
     * Create a new ValidResult object representing the result is invalid.
     * </p>
     *
     * @param message a string describing why the validation fails
     * @param filter  the Filter that fails the validation
     ...
     *
     *
     * @return a boolean indicating if the result is valid. true if valid, false
     *         otherwise
     */
