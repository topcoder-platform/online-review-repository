 ...
 * It is used to construct associative Filter. This abstract class also provides
 * concrete addFilter()
 ...
 * The attribute is protected not private, because the subclass of this abstract
 * class
 * should have the access to the attribute.
 * </p>
 *
 * <p>
 * The clone method is updated in version 1.3.
 * </p>
 *
...
public abstract class AbstractAssociativeFilter implements Filter {
    /**
     * It will hold a list of Filter objcts, which consists of the associative
     * filter. Null elemnt is not allowed.
     *
     */
     ...
     * @throws IllegalArgumentException if param is empty or the members in the list
     *                                  is not instanceof filter
     */
    ...
    /**
     * <p>
     * This method overrides the clone method to provide a deep copy of all the
     * filters within.
     * </p>
     *
     * <p>
