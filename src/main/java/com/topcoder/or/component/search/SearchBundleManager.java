...
import com.topcoder.or.component.datavalidator.NullValidator;
...
/**
 * This class manages a collection of SearchBundle objects. It provides APIs to
 * allow user
 * application to manage the collection of SearchBundle objects.. Including set
 * the collection of
 * SearchBundle,remove one SearchBundle,add one SearchBundle. Also clear the
 * SearchBundles.The
 * SearchBundles in the manager in initialized in the constructor, in which all
 * the SearchBundles
...
public class SearchBundleManager {
  ...
  @Autowired
  private SearchBundleConfig searchBundleConfigList;
  @Autowired
  ...
  /**
   * Get all the names of the SearchBundles in the manager. return as a list
   * format.
   *
