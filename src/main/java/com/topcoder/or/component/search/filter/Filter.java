...
/**
 * This interface defines APIs that every implementation must adhere to. It is
 * part of the composite
 * pattern. It is a common interface for both individual and composite
 * components so that both the
 * individual components and composite components can be viewed uniformly. It
