 ...
 * comparing entities such as numbers.
 * </p>
 *
 * <p>
 * All the possible directions are enumerated here such as equal,
...
final class CompareDirection implements Serializable {
    ...
    /**
     * <p>
     * <code>String</code> to be returned by <code>toString()</code>. This is
     * initialized in the constructor and is
     * immutable after that. It will simply hold the code value of the enumeration
     * item.
     * </p>
     */
    ...
    /**
     * <p>
     * Creates a new <code>CompareDirection</code>. This takes a <code>String</code>
