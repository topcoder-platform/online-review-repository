 ...
 */
package com.topcoder.or.component.datavalidator;

/**
 * <p>
 * This is a simple integer validator abstraction which basically checks that a
 * given value conforms with a specific
 * integer definition.
 * </p>
 *
 * <p>
 * This validator is abstract and will need to be extended to actually provide
 * the validation routine for a specific
 * integer value validation. Note that this validator acts as a factory that
 * allows for creation of other specialized
 * <code>IntegerValidator</code> instances that provide a number of convenience
 * methods which validate such aspects as
 * range (from , to, and could also be exclusive of extremes) or general
 * comparison of values such as greater-than,
 * less-than, etc... We can also create validators which validate if a number is
 * positive or negative, or even if it
 * is odd or even (i.e. parity comparison) User will need to implement the
 * <code>valid(int value) </code> method to
...
public abstract class IntegerValidator extends AbstractObjectValidator {
    ...
    /**
     * <p>
     * Creates a new <code>IntegerValidator</code> with a specific resource bundle
     * information.
     * </p>
     *
     ...
     * <code>Integer</code>, or a <code>String</code>
     * representation of an <code>int</code>. If so, it passes the <code>int</code>
     * value to <code>valid(int)</code>.
     * Otherwise, it returns <code>false</code>.
     * </p>
     *
     * @param obj <code>Object</code> to validate.
     *
     * @return <code>true</code> if <code>obj</code> is valid; <code>false</code>
     *         otherwise.
     */
    ...
    /**
     * <p>
     * This validates the given primitive <code>int</code> value. It is an
     * <code>abstract</code> method, so it should
     * be overridden in subclasses to implement the specific validation routines.
     * </p>
     *
     * @param value <code>int</code> value to validate.
     *
     * @return <code>true</code> if <code>value</code> is valid; <code>false</code>
     *         otherwise.
     */
    ...
    /**
     * <p>
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * greater than <code>value</code>.
     * </p>
     *
     * @param value exclusive lower bound of valid values.
     *
     * @return an <code>IntegerValidator</code> that would perform the desired
     *         validation.
     */
     ...
     *
     * @return <code>null</code> if <code>obj</code> is valid. Otherwise, an error
     *         message is returned.
     */
    /**
     * <p>
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * greater than <code>value</code> and
     ...
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * greater than or equal to
     * <code>value</code> and initializes the validator with a specific resource
     * bundle information.
     * </p>
     *
     * @param value      inclusive lower bound of valid values.
     ...
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * between <code>lower</code> and
     * <code>upper</code> inclusive and initializes the validator with a specific
     ...
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * between <code>lower</code> and
     * <code>upper</code> exclusive and initializes the validator with a specific
     * resource bundle information.
     * </p>
     *
     * @param lower      exclusive lower bound of valid values.
     ...
     * <p>
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * odd numbers and initializes the
     * validator with a specific resource bundle information.
     * </p>
     *
     * @param bundleInfo resource bundle information
     ...
     * <p>
     * Creates an <code>IntegerValidator</code> which would test whether inputs are
     * even numbers and initializes the
     * validator with a specific resource bundle information.
     * </p>
     *
     * @param bundleInfo resource bundle information
    ...
    /**
     * <p>
     * Gives error information about the given primitive <code>int</code> value. It
     * is an <code>abstract</code> method,
     * so it should be overridden in subclasses to implement the specific validation
     * routines.
     * </p>
     *
     * @param value <code>int</code> value to validate.
     *
     * @return <code>null</code> if <code>value</code> is valid. Otherwise, an error
     *         message is returned.
     */
    ...
    /**
     * <p>
     * This is something of an adapter class which gives us a simple implementation
     * of the abstract IntegerValidator
     * class. Note that this will wrap around any type of a validator but since this
     * is an internal class only
     * IntegerValidator class is expected.
     * </p>
     *
     * <p>
     * <b>Thread Safety:</b>This is an inner class to IntegerValidator. It is
    ...
    static class IntegerValidatorWrapper extends IntegerValidator {
        /**
         * <p>
         * The underlying validator to use. This is initialized through the constructor
         * and is immutable after that. It
         ...
         * Creates a new <code>IntegerValidatorWrapper</code> that uses
         * <code>validator</code> as the underlying
         * <code>ObjectValidator</code> and initializes the validator with a specific
         * resource bundle information.
         * </p>
         *
         * @param validator  the underlying <code>ObjectValidator</code> to use.
        ...
        /**
         * <p>
         * If the given <code>int</code> value is valid, this returns <code>null</code>.
        ...
        /**
         * <p>
         * Gives error information about the given object being validated. This method
         * will return possibly a number of
         * messages produced for this object by a number of validators if the validator
         * is composite.
         * </p>
         *
        ...
        /**
         * <p>
         * This is the same method concept as the <code>getMessage()</code> except that
         * this method will evaluate the
         * whole validator tree and return all the messages from any validators that
         * failed the object. In other words
        ...
        /**
         * <p>
         * This is another version of the <code>getAllMessages()</code> method which
         * accepts a limit on how many
         * messages at most will be requested. This means that the traversal of the
         * validator tree will stop the
         * moment messageLimit has been met. This is provided so that the user can limit
         * the number of messages coming
         * back and thus limit the traversal time but still get a reasonable number of
         * messages back to the user.
         * </p>
         *
         * @param object       the object to validate
         * @param messageLimit the max number of messages. This must be
    ...
    /**
     * <p>
     * This is an extension of the IntegerValidator which specifically deals with
     * validating comparisons based criteria
     * such equal, greater-than-or-equal, less-than, less-than-or-equal,
     * greater-than. Thus we will have a validation
     * based on a specific initilization value (that is set with the validator) and
     * then have this validator compare
     * the input value with the set value using one of the specific comparison
     * directions. This is an inner class to
     * IntegerValidator.
     * </p>
     *
     * <p>
    ...
    static class CompareIntegerValidator extends IntegerValidator {
        /**
         * <p>
         * The value to compare inputs with. This is the validator initilization value
         * which is set in the constructor
         * and once set is immutable. This cannot be null and represents the value
         * against which the input values will
         * be compared.
         * </p>
         */
        ...
        /**
         * <p>
         * The direction for comparing inputs. This is initialized in the constructor
         * and is immutable therafter. It
         * cannot be null.
         * </p>
         */
        ...
        /**
         * <p>
         * Creates a new <code>CompareIntegerValidator</code> that compares inputs to
         * <code>value</code>, in the
         ...
         * Creates a new <code>CompareIntegerValidator</code> that compares inputs to
         * <code>value</code>, in the
         * direction determined by <code>direction</code> and initializes the validator
     ...
     * <p>
     * This is an extension of the IntegerValidator which specifically deals with
     * validating numbers based on their
     * parity (i.e. if the number is odd or even) Which parity should be validated
     * against is set as a flag when
     * creating/initializing this validator and is basically odd (true) or even
     * (false) As an example, if we create an
     * instance of this validator set with a parity of odd (true) which would then
     * accpet only integers that are odd.
    ...
    static class ParityIntegerValidator extends IntegerValidator {
        /**
         * <p>
         * This represnts whether inputs must be odd or even. This is the validator
         * initilization value which is set in
        ...
        /**
         * <p>
         * Creates a new <code>ParityIntegerValidator</code> that checks whether inputs
         * are odd or even.
         * </p>
         *
         * @param isOdd <code>true</code> if inputs must be odd; <code>false</code> if
         *              inputs must be even.
         */
         ...
         * <p>
         * Creates a new <code>ParityIntegerValidator</code> that checks whether inputs
         * are odd or even and initializes
         * the validator with a specific resource bundle information.
         * </p>
         *
         * @param isOdd      <code>true</code> if inputs must be odd; <code>false</code>
         *                   if inputs must be even.
         * @param bundleInfo resource bundle information
         */
