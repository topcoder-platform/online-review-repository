...
/**
 * <p>
 * This is a simple String validator abstraction which basically checks that a
 ...
 * string value validation. Note that this validator comes with a number of
 * convenience factory methods which create
 * specific validators which can tests/validate such aspects as if a string
 * starts with or end with some string. We
 * also have the ability to create validators that will test for string
 * containment (i.e. a string is valid if it
 * contains a certain substring) or validators that test for length based
 * comparisons such as exact length or a range.
 * We also have the ability to create validators that test an input string
 * against specific regular expression. User
 * will need to implement the <code>valid(String value) </code> method to decide
 * what the validator will do with the
 * input String.
 * </p>
 *
 * <p>
...
public abstract class StringValidator extends AbstractObjectValidator {
    ...
    /**
     * <p>
     * Creates a new <code>StringValidator</code> with a specific resource bundle
     * information.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts the given <code>Object</code> to a <code>String</code> by calling
     * its <code>toString()</code> method,
    ...
    /**
     * <p>
     * This validates the given <code>String</code>. It is an <code>abstract</code>
     * method, so it should be overridden
     * in subclasses to implement the specific validation routines.
     * </p>
     *
     * @param str <code>String</code> value to validate.
     *
     * @return <code>true</code> if <code>str</code> is valid; <code>false</code>
     *         otherwise.
     */
    ...
    /**
     * <p>
     * Creates a new <code>StringValidator</code> which would test whether inputs
     * start with <code>str</code>.
     * </p>
     *
     * @param str check that inputs start with this <code>String</code>.
     *
     * @return a <code>StringValidator</code> that would perform the desired
     *         validation.
     *
     ...
     * <p>
     * Creates a new <code>StringValidator</code> which would test whether inputs
     * start with <code>str</code> using a
     ...
     * <p>
     * Creates a new <code>StringValidator</code> which would test whether inputs
     * end with <code>str</code> using a
     * specified resource bundle information.
     * </p>
     *
     * @param str        check that inputs end with this <code>String</code>.
     ...
     * <p>
     * Creates a new <code>StringValidator</code> which would test whether inputs
     * have a length that the given
     * <code>IntergerValidator</code> accepts as valid.
     * </p>
     *
     * @param validator <code>IntegerValidator</code> that will be used to validate
     ...
     * Creates a new <code>StringValidator</code> which would test whether inputs
     * have a length that the given
     * <code>IntergerValidator</code> accepts as valid using a specified resource
     * bundle information.
     * </p>
     *
     * @param validator  <code>IntegerValidator</code> that will be used to validate
    ...
    /**
     * <p>
     * If the given <code>Object</code> is valid, this returns <code>null</code>.
    ...
    /**
     * <p>
     * Gives error information about the given <code>String</code>. It is an
     ...
     *
     * @return <code>null</code> if <code>str</code> is valid. Otherwise, an error
     *         message is returned.
     */
    ...
    /**
     * <p>
     * This is an extension of the StringValidator which specifically deals with
     * validating strings based on testing
     * that strings start with a specific string. As an example, if we create an
     * instance of this validator set with a
     * string of "hello" then any user input that would start with this string
     * (case-insensitive) would be considered
     * valid. This is an inner class to StringValidator. This class is thread-safe
     * as it is immutable.
     * </p>
     *
     * <p>
    ...
    static class StartsWithStringValidator extends StringValidator {
        /**
         * <p>
         * Inputs must start with this string. This is initialized in the constructor
         * and is immutable once set. it
        ...
        /**
         * <p>
         * Creates a new <code>StartsWithStringValidator</code> that checks whether
        ...
        /**
         * <p>
         * If the given <code>String</code> is valid, this returns <code>null</code>.
         * Otherwise, it returns an error
         * message.
         * </p>
         *
     ...
     * This is an extension of the StringValidator which specifically deals with
     * validating strings based on testing
     * that strings end with a specific string. As an example, if we create an
     * instance of this validator set with a
     * string of "world" then any user input that would end with this string
     * (case-insensitive) would be considered
     * valid. This is an inner class to StringValidator. This class is thread-safe
     * as it is immutable.
     * </p>
    ...
    static class EndsWithStringValidator extends StringValidator {
        /**
         * <p>
         * Inputs must end with this string. This is initialized in the constructor and
         * is immutable once set. it
         * cannot be null but could be an empty string
         * </p>
         */
        private final String str;
        ...
        /**
         * <p>
         * Creates a new <code>EndsWithStringValidator</code> that checks whether inputs
         * end with <code>str</code>.
         * </p>
         *
     ...
     * <p>
     * This is an extension of the StringValidator which specifically deals with
     * validating strings based on substring
     * containment. This means that we will be validatng user input as bing valid it
     * is contains the string that this
     * validator has been initialized with. As an example, if we create an instance
     * of this validator set with a
     * string of "hello" then any user input that would contain this string
     * (case-insensitive) would be considered
     * valid. This is an inner class to StringValidator. This class is thread-safe
     * as it is immutable.
     * </p>
    ...
    static class ContainsStringValidator extends StringValidator {
         ...
         * constructor and is immutable once set.
        ...
        /**
         * <p>
         * Creates a new <code>ContainsStringValidator</code> that checks whether inputs
         * contain <code>str</code>.
         * </p>
         *
     ...
     * <p>
     * This is an extension of the StringValidator which specifically deals with
     * validating strings based on their
     * length. note that the actual validation is performed based on an
     * IntegerValidator which means that we could
     * have this validator do all the integer validations including range validation
     * of the length. As an example, if
     * we create an instance of this validator set with an IntegerValidator which
     * checks that a number is in range of
     * 2..10 inclusive then any user input that would have its length in that range
     * would be considered valid. This is
    ...
    static class LengthStringValidator extends StringValidator {
        /**
         * <p>
         * The underlying <code>IntegerValidator</code> to use. This is the validator
         * initilization value which is set
         * in the constructor and once set is immutable. This cannot be null and
         * represents the validator doing the
         ...
         * <code>IntegerValidator</code> to check
         ...
         * Creates a new <code>LengthStringValidator</code> that uses the given
         * <code>IntegerValidator</code> to check
         * whether the length of inputs are valid and initializes the validator with a
    ...
    /**
     * <p>
     * This is an extension of the <code>StringValidator</code> which specifically
     * deals with validating strings based
     * on a regular expression. This is an inner class to
     * <code>StringValidator</code>. This class is thread-safe as
     * it is immutable.
     * </p>
     *
    ...
    static class RegexpStringValidator extends StringValidator {
         ...
         * constructor and is used to initialize
        ...
        /**
         * <p>
         * The regular expression as a pattern. This is initialized in the constructor.
         * It cannot be null. It is
         ...
         *
         * @throws IllegalArgumentException if <code>str</code> is <code>null</code> or
         *                                  is an empty string. It will
         *                                  also be thrown if there are issues with
         ...
         * expression that this validator has
         ...
         * If the given <code>String</code> is valid , this returns <code>null</code>.
         * Otherwise, it returns an error
         * message. To test validity this method will test to see if it matches the
         * regular expression that this
