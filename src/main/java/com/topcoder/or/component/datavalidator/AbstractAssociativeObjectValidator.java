...
/**
 * <p>
 * This is an abstract class that is used to abstract functionality of validator
 * composition. It is basically a
 * composition of 0 or more validators.
 * </p>
 *
 * <p>
 * This class gives its descendants the ability to manipulate the aspects of
 * validator composition. The validators are
 * guaranteed to be placed in a normal list order which means that the first
 * validator added to this composition will
 * be the first that is returned through the iterator, the second will be the
 * second one returned, etc...
 * </p>
 *
 * <p>
 * <b>Thread Safety:</b> This class is thread-safe through synchronization of
 * the validators list.
 * </p>
 *
...
public abstract class AbstractAssociativeObjectValidator extends AbstractObjectValidator {
    /**
     * <p>
     * The list of validators to use. This is initialized in the constructor to an
     * empty <code>ArrayList</code>, the
     * reference is immutable. this was changed in version 1.1 to support TopCoder
     * coding conventions
     * </p>
     */
    ...
    /**
     * <p>
     * Creates a new <code>AbstractAssociativeObjectValidator</code>, with initially
     * no associated validators.
     * </p>
     */
    ...
    /**
     * <p>
     * Creates a new <code>AbstractAssociativeObjectValidator</code>, with 2 initial
     ...
     * <p>
     * Creates a new <code>AbstractAssociativeObjectValidator</code> with 2 initial
     * <code>ObjectValdiators</code> and
     ...
     *
     * @throws IllegalArgumentException if either <code>validator1</code> or
     *                                  <code>validator2</code> is
     *                                  <code>null</code>.
     * @throws IllegalArgumentException if the <code>bundleInfo</code> is null, or
     *                                  if the <code>bundleName</code>,
    ...
    /**
     * <p>
     * Adds a new <code>ObjectValidator</code> to the list of associated validators.
     * This will be added to the end of
     * the list.
     * </p>
     *
     ...
     *                                  <code>null</code> or identical to the caller
     *                                  instance.
     *
     * @since 1.1
     */
     ...
     * validators. Note that removing a
    ...
    /**
     * <p>
     * Initial the <code>ObjectValdiators</code> with the given instances when
     * creating a new
