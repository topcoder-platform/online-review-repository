 ...
 * boolean NOT outcome of the associated
 * validator. In other words it reverses the validation outcome of the
 * associated validator. Note that the message
 * returned by this validator in case of failure doesn't take into account the
 * associated validator since it reverses
...
public class NotValidator extends AbstractObjectValidator {
    ...
    /**
     * <p>
     * Creates a new <code>NotValidator</code> that uses <code>validator</code> as
     * the underlying
     ...
     * Creates a new <code>NotValidator</code> that uses <code>validator</code> as
     * the underlying
     * <code>ObjectValidator</code> and is initialized with a specified resource
     * bundle information.
     * </p>
     *
     * @param validator  the underlying <code>ObjectValidator</code> to use.
