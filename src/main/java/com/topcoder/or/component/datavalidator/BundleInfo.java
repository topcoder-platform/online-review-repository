 ...
 * This a serializable bean and is not thread-safe. This doesn't affect the
 * thread-safety of the component since it
...
public class BundleInfo implements Serializable {
    /**
     * <p>
     * This represents the resource bundle used by this validator. It is set in one
     * of the constructors to either null
     * (not required) or to a specific named bundle. This is then used to fetch the
     * specific message based on a
     * resource key (which is also initialized in the same constructor). It is
     * transient since it is not serializable.
     ...
     * This is initialized in the setter but
     * since it is not required it can be null. This is used to create a named
     * resource bundle in one of the
    ...
    /**
     * <p>
     * This is the locale used to fetch the resource data. It identifies the locale
     * for the message key that will be
     * used to fetch the message for the validator. It will be initialized through a
     * setter and is mutable.
     * </p>
     */
     ...
     * current locale. THis will be used by
     * serialization to also use the current locale when being serialized. It will
     * be initialized through a setter and
    ...
    /**
     * <p>
     * This is a message key used to look up and fetch a message from a resource
     * bundle. It will be initialized through
     * a setter and is mutable. it is an optional variable and this it can be left
     * uninitialized (i.e. as null)
     * </p>
     */
     ...
     * resource bundle is not available or
     * simply not set. This will also apply to a situation where the bundle doesn't
     * contain the requested message.
     * This is basically a fail safe message. It will be initialized through a
     * setter and is mutable. It can be a null
    ...
    /**
     * <p>
     * Getter for the messageKey property. The messageKey is used to look up and
     * fetch a message from a resource
     * bundle.
     * </p>
     *
     * @return the message key used to look up and fetch a message from a resource
     *         bundle
     */
    ...
    /**
     * <p>
     * Setter for the messageKey property. The messageKey is used to look up and
     * fetch a message from a resource
     * bundle.
     * </p>
     *
     * @param messageKey the message key used to look up and fetch a message from a
     *                   resource bundle
     *
     ...
     *
     * @throws IllegalArgumentException if the bundleName is null or empty, or if
     *                                  the locale is null
     */
     ...
     * resource bundle to be read back in on
     * the other end.
     * </p>
     *
     * @param stream the serialization stream
     *
     * @throws IOException            if there were any issues with reading the
     *                                stream
     * @throws ClassNotFoundException if there were any issues with JVM trying to
     *                                find the specific class via class
     *                                loader.
     */
     ...
     * by the protocol since we did
     * override the readObject. There is nothing for us to do here since
     * reourceBundle is declared as transient and
